...
/* const userMail = prompt('inserisci la tua email'); */ /*togli il commento per far leggere questa CONST
e commenta l'altra const userMail*/

const userMail = document.getElementById("mail"); /*togli il commento per far leggere questa CONST
e commenta l'altra const userMail*/
...
button.addEventListener('click', function () {
  ...
  for (let i = 0; i < userList.length; i++)
    ...
    if (inputUserMail == userList[i]) {
      ...
      //mostra in console e in HTML il messaggio di accesso/non accesso
